namespace images {
    ...
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number0 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number1 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number10 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number2 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number3 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number4 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number5 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number6 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number7 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number8 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
    export const number9 = image.ofBuffer(hex``);
    //% fixedInstance jres blockIdentity=brick.__imagePicker
